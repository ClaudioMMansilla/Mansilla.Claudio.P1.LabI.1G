...
int main(void) {
	...
	do
	{
		...
		case 'B': // INFORMES
			...
			case 3:// 3- Informar Promedio de autos con caja manual y promedio de autos con caja automática\n");
			...
			case 6:// 6- Mostrar la o las marcas más elegidas por los clientes.\n");
